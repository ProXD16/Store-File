...
class MapDisplay:
    def __init__(self, master):
        ...
        self.path_points = []  # Khởi tạo danh sách đường đi
    ...
    def create_widgets(self):
        ...
        self.nav_goal_mode = False  # Biến để theo dõi chế độ Nav Goal

    def toggle_nav_goal_mode(self):
        self.nav_goal_mode = not self.nav_goal_mode
        button_color = "green" if self.nav_goal_mode else "SystemButtonFace"
